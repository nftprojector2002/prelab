...
let SectionData = {
  ...
  // Hero data three
  heroDataThree: {
    title: "PreLabTech discover rare artworks by world class artists",
    content:
      "PreLabTech, empowers you to launch your own white-label NFT store or NFT Marketplace without any technical knowledge",
  },
  // Breadcrumb data
  breadcrumbData: {
    breadcrumbList: {
  ...
  productData: {
    ...
    products: [
      ...
      },
      {
        ...
        content:
          "Bazzors is a tiny buzzing, electrifying and irascible Elfin. Bazzors appear intermittently during thunderstorms in the Elfin Kingdom ",
        author: "CanvaNetwork",
        authorLink: "author",
        price: "10.00",
        priceTwo: "0.32",
      ...
      },
      {
        ...
        content:
          "According to our idea, REAL BORED APE would look exactly like this. Have you ever seen this tough guy on the streets of your city?",
        author: "MoveNetwork",
        authorLink: "author",
        price: "8.00",
        priceTwo: "0.32",
      ...
      },
      {
        ...
        metaTextTwo: "200 editions",
        metaTextThree:
          'Highest bid <span class="text-primary fw-semibold">2.072 wETH</span>',
    ...
    featuredList: [
      {
        ...
        content:
          "Complete account of the system, and expound the actual things.",
        followerNum: "756",
  ...
  howItWorkData: {
    ...
    howItWorkList: [
      ...
      },
      {
        ...
        content:
          'Click <a href="profile" class="btn-link">My Collections</a> and set up your collection. Add social links, a description',
      },
      {
        id: 3,
  ...
  ctaData: {
    ...
    content:
      "I must explain to you how all this mistaken idea of the denouncing and praising pain was born and I will give you complete.",
  ...
  sellerSettingData: {
    title: "Seller Settings",
    content:
      'Current <strong>Authorized Seller </strong> Status: <strong class="text-warning">Restricted</strong>',
    contentTwo:
      "You must be an authorized seller in order to sell Enfties on EnftyMart. To authorize your account for sales, please sign in to Stripe Connect.",
    contentThree:
      "Even if you can't become an authorized seller, you can still use the rest of EnftyMart: buy & collect Enfties, gift them to other users, or withdraw them to an external wallet.",
    btnText: "Authorize Seller Account",
    contentFour:
      'If your country does not appear, it may not be supported by Stripe Connect. Please contact <a href="contact" class="btn-link">customer support</a>',
  },
  // security data
  securityData: {
    title: "Security",
  ...
  offerData: {
    ...
    alertText:
      'In order to sell NFTs on EnftyMart, you must <a href="seller-settings" class="btn-link">become an authorized seller.</a> It only takes a few minutes!',
    tabNav: [
      {
        id: 1,
        isActive: "active",
    ...
    purchaseData: [
      {
        id: 1,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Serpent #76/140</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$250.00</span>',
        dateText: "4d ago",
      },
      {
        id: 2,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Afterburn</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$34.00</span>',
        dateText: "5d ago",
      },
      {
        id: 3,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Dance or Die</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$13.00</span>',
        dateText: "5d ago",
      },
      {
        id: 4,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Green Parrot Island</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$15.00</span>',
        dateText: "5d ago",
      },
      {
        id: 5,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Lavish</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$34.00</span>',
        dateText: "6d ago",
      },
      {
        id: 6,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Karma Chameleon</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$32.00</span>',
        dateText: "6d ago",
      },
      {
        id: 7,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Le Anime</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$12.00</span>',
        dateText: "6d ago",
      },
      {
        id: 8,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Lady Robot #62</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$20.00</span>',
        dateText: "7d ago",
      },
      {
        id: 9,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Creature #8477</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$30.00</span>',
        dateText: "7d ago",
      },
      {
        id: 10,
        title:
          'You bought <a href="item-details" class="btn-link fw-medium">Gold #422/477</a> from <a href="#" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$50.00</span>',
        dateText: "7d ago",
      },
    ],
    salesData: [
      {
        id: 1,
        title:
          '<a href="author" class="btn-link fw-medium">David</a> bought <a href="item-details" class="btn-link fw-medium">Lady Robot #62</a> from You for <span class="fw-medium">$20.00</span>',
        dateText: "4d ago",
      },
      {
        id: 2,
        title:
          '<a href="author" class="btn-link fw-medium">Rob</a> bought <a href="item-details" class="btn-link fw-medium">Creature #8477</a> from You for <span class="fw-medium">$30.00</span>',
        dateText: "5d ago",
      },
      {
        id: 3,
        title:
          '<a href="author" class="btn-link fw-medium">Jared Liner</a> bought <a href="item-details" class="btn-link fw-medium">Gold #422/477</a> from You for <span class="fw-medium">$50.00</span>',
        dateText: "5d ago",
      },
      {
        id: 4,
        title:
          '<a href="author" class="btn-link fw-medium">Antonio</a> bought <a href="item-details" class="btn-link fw-medium">Serpent #76/140</a> from You for <span class="fw-medium">$250.00</span>',
        dateText: "5d ago",
      },
      {
        id: 5,
        title:
          '<a href="author" class="btn-link fw-medium">Jhon</a> bought <a href="item-details" class="btn-link fw-medium">Afterburn</a> from You for <span class="fw-medium">$34.00</span>',
        dateText: "6d ago",
      },
      {
        id: 6,
        title:
          '<a href="author" class="btn-link fw-medium">Kevin Martin</a> bought <a href="item-details" class="btn-link fw-medium">Dance or Die</a> from You for <span class="fw-medium">$13.00</span>',
        dateText: "6d ago",
      },
      {
        id: 7,
        title:
          '<a href="author" class="btn-link fw-medium">Once</a> bought <a href="item-details" class="btn-link fw-medium">Green Parrot Island</a> from You for <span class="fw-medium">$15.00</span>',
        dateText: "6d ago",
      },
      {
        id: 8,
        title:
          '<a href="author" class="btn-link fw-medium">Kamran</a> bought <a href="item-details" class="btn-link fw-medium">Lavish</a> from You for <span class="fw-medium">$34.00</span>',
        dateText: "7d ago",
      },
      {
        id: 9,
        title:
          '<a href="author" class="btn-link fw-medium">Abe</a> bought <a href="item-details" class="btn-link fw-medium">Karma Chameleon</a> from You for <span class="fw-medium">$32.00</span>',
        dateText: "7d ago",
      },
      {
        id: 10,
        title:
          '<a href="author" class="btn-link fw-medium">Robert</a> bought <a href="item-details" class="btn-link fw-medium">Le Anime</a> from You for <span class="fw-medium">$12.00</span>',
        dateText: "7d ago",
      },
    ],
  },
  ...
  creditCardList: [
    {
      ...
      addressText:
        "123 Fake Sreet, 3rd Floor, San Francisco, California, 94105, United States",
    },
    {
      id: 2,
      ...
      titleTwo: "Billing address",
      addressText:
        "240 Descano Drive, Level 5, San Francisco, California, 34105, United States",
    },
  ],
  // credit card data
  creditCardData: {
    alertText:
      "Using a Capital One card may lead to issues completing purchases. Please consider using a different card until further notice.",
  ...
  createData: {
    ...
    content:
      "Choose <strong>“Single”</strong> if you want your collectible to be one of a kind.",
    cards: [
      {
        id: 1,
        title: "Single",
  ...
  prepaidData: {
    ...
    contentTwo:
      "To increase your balance, send ETH to your deposit address below. ETH will be valued at USD market value at time of purchase. Gas fees will be subtracted from withdrawal amounts.",
    balances: [
      {
        id: 1,
        title: "Balance",
  ...
  displayEnftyData: {
    ...
    contentTwo:
      "Please allow for up to 40 seconds for your changes to be reflected on your display screen",
  },
  // redeem enfty data
  redeemEnftyData: {
    mainTitle: "Redeem Enfties",
    content:
      "Redemptions reward the top collectors of a particular artist by gifting them a nifty if a collector has a certain number of pieces from a particular collection on their account.",
  ...
  depositData: {
    ...
    contentTwo:
      'Metamask browser extension is required. Visit <a href="https://metamask.io/">metamask.io</a> to learn more.',
  ...
  depositNiftyModal: {
    title: "Deposit Enfty",
    content:
      "Only Enfties registered in Enfty Gateway collections can be deposited. Check if your Enfty is compatible below:",
  ...
  aboutDataTwo: {
    ...
    contentThree:
      "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus, quasi consectetur. Et delectus minus saepe cumque qui harum! Aperiam, dolorem itaque!",
    contentFour:
      "Today, <strong>we’re proud to remain the largest general marketplace for user-owned digital items</strong>, supporting multiple blockchains, with the broadest set of categories",
  ...
  walletData: [
    ...
    },
    {
      ...
      title: "Fortmatic",
      content:
        "Let users access your Ethereum app from anywhere. No more browser extensions ellipsis.",
      btnText: "Connect",
      path: "login",
    },
    {
    ...
    },
    {
      ...
      title: "Coinbase",
      content:
        "The easiest and most secure crypto wallet. No Coinbase account required to connect EnftyMart.",
      btnText: "Connect",
      path: "login",
    },
    {
  ...
  placeBidModal: {
    title: "Place a Bid",
    content:
      "You are about to place a bid for <strong>The Future is Blossoming - Harlows 2021</strong> from <strong>Nathan walls</strong>",
    labelText: "Your bid (ETH)",
    labelTextTwo:
      'Enter quantity <span class="text-primary">5 available</span>',
    totalBidList: [
      {
  ...
  reportModalData: {
    ...
    content:
      "If you believe there's been a violation of PreLabTech's Terms of Service or Community Guidelines, please complete this report.",
    contentTwo:
      'For all cases related to potential copyright infringement, please email <a href="mailto:trust@enftymart.com">trust@enftymart.com</a> directly with a formal DMCA Takedown Request.',
    placeholderText:
      "Describe why you think this page should be removed from EnftyMart.",
    btnText: "Submit",
  },
  followersModal: {
    title: "Why are you reporting?",
  ...
  copyTitle: "Copyright © 2022 PreLabTech.",
};
